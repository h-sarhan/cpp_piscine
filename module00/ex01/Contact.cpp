...
/*   Updated: 2022/09/18 07:33:19 by hsarhan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Contact.hpp"

Contact::Contact(void) : _created(false) {}

Contact::Contact(const std::string &firstName, const std::string &lastName,
                 const std::string &nickName, const std::string &phoneNumber,
                 const std::string &secret)
    : _created(true), _firstName(firstName), _lastName(lastName), _nickName(nickName),
...
Contact &Contact::operator=(const Contact &contact)
{
    ...
    this->_created = contact._created;
    return (*this);
}
...
bool Contact::getCreated(void) const { return (_created); }
